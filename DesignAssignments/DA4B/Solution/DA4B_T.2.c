...
int main(void) {
	...
	DDRB |= 0x3E; //PB5-PB2 as outputs 0011 1110
	...
	while (1) {											// Infinite loop
		...
		OCR1A=potOCR;   //0 degree around 130/40 and 180 degree around 550/580
		_delay_ms(250);
...
void Timer1_init(void) {					// Function to Initialize Timer0 properties
	...
	//NON Inverted PWM //PRESCALER=64 MODE 14(FAST PWM)
...
void read_adc(void) {
	...
	volt = (adc_val*5.0)/1023.0;
	percent = (volt/5.0)*100.0;
	potOCR = (volt/5.0)*524.0;
}